...
@section('content_header')
        <div class="row">
            <nav class="col breadcrumb_custom"><a href="{{ route('operacional.index') }}">Dashboard</a> > <a href="{{ route('projetos.index') }}">Projetos</a> > Novo Projeto</nav>
        </div>
@stop
                        ...
                        <div class="form-group col-md-2 col-sm-6">
                            ...
                            <select name="estacao" id="estacao" class="form-control @error('estacao') is-invalid @enderror" id="estacao" value="{{ old('estacao') }}">
                                ...
                                @foreach ($estacoes as $estacao)
                                    <option value="{{ $estacao->id }}">{{ $estacao->sigla }} - {{ $estacao->descricao }}</option>
                                @endforeach                                
                            </select>
                        </div>
                        <div class="form-group col-md-2 col-sm-6">
